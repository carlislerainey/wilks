...
I named files and directory so that their purpose can (hopefully) be understood from the name. The [`Makefile`](Makefile) formally documents the relationship among the files and the steps to reproduce my work.
